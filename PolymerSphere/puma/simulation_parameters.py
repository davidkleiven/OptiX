...
params_simu.pathToTarget = '/home/david/Documents/OptiX/PolymerSphere/puma'
...
params_simu.BISTATIC_EXCITATION_J_DIPOLES_FILENAME = ""
...
if params_simu.BISTATIC_EXCITATION_PLANE_WAVE == 1:
    ...
    params_simu.theta_inc = 0.0
    params_simu.phi_inc = 0.0
    params_simu.E_inc_theta = 0.0+0.j # the theta component
    params_simu.E_inc_phi = 1.0+0.j # the phi component
